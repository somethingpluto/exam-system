import { computed, ref, toRef, UnwrapRef, watch, watchEffect } from 'vue'
 ...
 * @returns 对 model 数据的引用
 */
export const useModelRef = <P extends Object, E extends Function, K extends keyof P>(props: P, key: K, emit: E) => {
  return computed<P[K]>({
    get() {
      return props[key]
    },
